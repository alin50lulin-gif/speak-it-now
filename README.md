...
- 按网站一键禁用：在不需要朗读功能的网站中一键隐藏全部页面控件，再次点击即可恢复。
...
打开扩展设置的 `Page Controls`，点击 `Disable on this site`。扩展会立即停止当前播放，并隐藏该网站上的浮动图标、悬停选段和迷你播放器。再次点击 `Enable on this site` 即可恢复，其他网站不受影响。
